...
var G__39840 = o;
goog.object.set(G__39840,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__40086__delegate = function (args){
...
while (G__40087__i < G__40087__a.length) {G__40087__a[G__40087__i] = arguments[G__40087__i + 0]; ++G__40087__i;}
  args = new cljs.core.IndexedSeq(G__40087__a,0,null);
} 
return G__40086__delegate.call(this,args);};
...
return G__40086__delegate(args);
});
...
var G__39857 = o;
goog.object.set(G__39857,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__40095__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__40096__i < G__40096__a.length) {G__40096__a[G__40096__i] = arguments[G__40096__i + 0]; ++G__40096__i;}
  args = new cljs.core.IndexedSeq(G__40096__a,0,null);
} 
return G__40095__delegate.call(this,args);};
G__40095.cljs$lang$maxFixedArity = 0;
G__40095.cljs$lang$applyTo = (function (arglist__40097){
var args = cljs.core.seq(arglist__40097);
return G__40095__delegate(args);
});
...
var G__39867 = props;
var G__39867__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39867,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39867);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39867__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39869 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39869,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39869;
}
})(),id_class);
...
var temp__5735__auto___40100 = (function (){var and__4115__auto__ = js_props;
...
var d_40104 = temp__5735__auto___40100;
if((d_40104 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_40104.s}));
} else {
...
var G__39872 = (cljs.core.count(argv) - first_child);
switch (G__39872) {
case (0):
...
var vec__39880 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39880,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39880,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39880,(2),null);
...
var temp__5739__auto___40143 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___40143 == null)){
} else {
var key_40145 = temp__5739__auto___40143;
(jsprops.key = key_40145);
}
...
var temp__5739__auto___40147 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___40147 == null)){
} else {
var key_40148 = temp__5739__auto___40147;
(jsprops.key = key_40148);
}
...
var temp__5739__auto___40157 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___40157 == null)){
} else {
var key_40159 = temp__5739__auto___40157;
(jsprops.key = key_40159);
}
...
var temp__5739__auto___40185 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___40185 == null)){
} else {
var key_40186 = temp__5739__auto___40185;
(jsprops.key = key_40186);
}
...
var temp__5739__auto___40195 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___40195 == null)){
} else {
var key_40197 = temp__5739__auto___40195;
(jsprops.key = key_40197);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39935_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39935_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39966 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39966,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39966,(1),null);
...
break;
default:
var G__40217 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__40218 = compiler;
v = G__40217;
compiler = G__40218;
continue;
...
var G__40001 = tag;
var G__40001__$1 = (((G__40001 instanceof cljs.core.Keyword))?G__40001.fqn:null);
switch (G__40001__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template40014 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template40014 = (function (opts,id,fn_to_element,parse_fn,meta40015){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template40014.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40016,meta40015__$1){
var self__ = this;
var _40016__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template40014(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta40015__$1));
}));

(reagent.impl.template.t_reagent$impl$template40014.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40016){
var self__ = this;
var _40016__$1 = this;
return self__.meta40015;
}));

(reagent.impl.template.t_reagent$impl$template40014.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template40014.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template40014.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template40014.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template40014.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template40014.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta40015","meta40015",-621961643,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template40014.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template40014.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template40014");

(reagent.impl.template.t_reagent$impl$template40014.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template40014");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template40014.
 */
reagent.impl.template.__GT_t_reagent$impl$template40014 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template40014(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta40015){
return (new reagent.impl.template.t_reagent$impl$template40014(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta40015));
});

}

return (new reagent.impl.template.t_reagent$impl$template40014(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
