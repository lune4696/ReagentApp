...
var G__43369 = o;
goog.object.set(G__43369,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__43706__delegate = function (args){
...
return G__43706__delegate.call(this,args);};
G__43706.cljs$lang$maxFixedArity = 0;
G__43706.cljs$lang$applyTo = (function (arglist__43716){
var args = cljs.core.seq(arglist__43716);
return G__43706__delegate(args);
});
...
var G__43421 = o;
goog.object.set(G__43421,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__43749__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__43755__i < G__43755__a.length) {G__43755__a[G__43755__i] = arguments[G__43755__i + 0]; ++G__43755__i;}
  args = new cljs.core.IndexedSeq(G__43755__a,0,null);
} 
return G__43749__delegate.call(this,args);};
G__43749.cljs$lang$maxFixedArity = 0;
G__43749.cljs$lang$applyTo = (function (arglist__43757){
var args = cljs.core.seq(arglist__43757);
return G__43749__delegate(args);
});
...
var G__43436 = props;
var G__43436__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43436,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__43436);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43436__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__43496 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43496,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__43496;
}
})(),id_class);
...
var temp__5735__auto___43786 = (function (){var and__4115__auto__ = js_props;
...
if(cljs.core.truth_(temp__5735__auto___43786)){
var d_43793 = temp__5735__auto___43786;
if((d_43793 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_43793.s}));
} else {
...
var G__43513 = (cljs.core.count(argv) - first_child);
switch (G__43513) {
case (0):
...
var vec__43552 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43552,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43552,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43552,(2),null);
...
var temp__5739__auto___43823 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___43823 == null)){
} else {
var key_43824 = temp__5739__auto___43823;
(jsprops.key = key_43824);
}
...
var temp__5739__auto___43826 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___43826 == null)){
} else {
var key_43827 = temp__5739__auto___43826;
(jsprops.key = key_43827);
}
...
var temp__5739__auto___43829 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___43829 == null)){
} else {
var key_43830 = temp__5739__auto___43829;
(jsprops.key = key_43830);
}
...
var temp__5739__auto___43842 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___43842 == null)){
} else {
var key_43843 = temp__5739__auto___43842;
(jsprops.key = key_43843);
}
...
var temp__5739__auto___43847 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___43847 == null)){
} else {
var key_43848 = temp__5739__auto___43847;
(jsprops.key = key_43848);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43641_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__43641_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__43651 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43651,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43651,(1),null);
...
break;
default:
var G__43871 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__43872 = compiler;
v = G__43871;
compiler = G__43872;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template43666 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template43666 = (function (opts,id,fn_to_element,parse_fn,meta43667){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template43666.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_43668,meta43667__$1){
var self__ = this;
var _43668__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template43666(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta43667__$1));
}));

(reagent.impl.template.t_reagent$impl$template43666.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_43668){
var self__ = this;
var _43668__$1 = this;
return self__.meta43667;
}));

(reagent.impl.template.t_reagent$impl$template43666.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template43666.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template43666.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template43666.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template43666.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template43666.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta43667","meta43667",556450501,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template43666.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template43666.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template43666");

(reagent.impl.template.t_reagent$impl$template43666.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template43666");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template43666.
 */
reagent.impl.template.__GT_t_reagent$impl$template43666 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template43666(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta43667){
return (new reagent.impl.template.t_reagent$impl$template43666(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta43667));
});

}

return (new reagent.impl.template.t_reagent$impl$template43666(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
