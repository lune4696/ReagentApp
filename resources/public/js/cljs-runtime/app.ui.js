...
var with_let44123 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let44123","with-let44123",-2039860384));
var temp__5739__auto___44128 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5739__auto___44128 == null)){
} else {
var c__34574__auto___44129 = temp__5739__auto___44128;
if((with_let44123.generation === c__34574__auto___44129.ratomGeneration)){
...
(with_let44123.generation = c__34574__auto___44129.ratomGeneration);
}

var init44124 = (with_let44123.length === (0));
var sec = ((((init44124) || (cljs.core.not(with_let44123.hasOwnProperty((0))))))?(with_let44123[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((0))):(with_let44123[(0)]));
var res44125 = (function (){
setTimeout((function (){
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(value),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__44126_SHARP_){
return cljs.core.reset_BANG_(value,p1__44126_SHARP_.target.value);
})], null)], null);
});
...
var G__44127 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(data,param,new_value),invalidates);
return (recalc.cljs$core$IFn$_invoke$arity$1 ? recalc.cljs$core$IFn$_invoke$arity$1(G__44127) : recalc.call(null,G__44127));
}));
})], null)], null);
});
/**
